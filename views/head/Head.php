...
class Head implements HeadInterface
{
    ...
    {
        if (isset($this->aBase['href']) && !empty($this->aBase['href'])) {
            echo PHP_EOL
                . '<base href="' . $this->aBase['href'] . '"'
                . ((isset($this->aBase['target']) && !empty($this->aBase["target"])) ? ' target="' . $this->aBase['target'] . '"' : '')
                . '/>';
        }
    }
     ...
     */
    private function renderMetaName()
    {
        $sMetaNameElements = '';
     ...
     */
    private function renderMetaHttpEquiv()
    {
     ...
     */
    private function renderMetaProperty()
    {
     ...
     */
    private function renderInlineStyle()
    {
        $sInlineStyle = '';
     ...
     * @throws HeadException
     */
    private function addLink($sPrependOrAppend, $sHref, $aAttributes = array(), $sKey = null)
    {
        // check href
        $sHref = trim($sHref, '/');
